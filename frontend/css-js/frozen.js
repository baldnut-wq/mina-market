...
// Toggle filter section
    ...
    // frozen products data (fallback)
    const frozenProducts = [
        {id: "f1",
        name: "Mixed Vegetables",
        category: "frozen",
        subcategory: "vegetables",
        description: "A delicious blend of peas, corn, carrots, and green beans.",
        image: "./img/mixed-vegetables.jpg",
        price: 4.99,
        originalPrice: 5.99,
        badge: "Sale",
        rating: 4.5,
     ...
     },
     {
        ...
        category: "frozen",
        subcategory: "seafood",
        description: "Premium wild-caught salmon fillets, individually vacuum-sealed.",
        image: "./img/salmon-fillets.jpg",
        price: 12.99,
        originalPrice: null,
        badge: "Popular",
        rating: 4.8,
     ...
     ,
        // Add more frozen products here as needed
    ];
    ...
    let currentPage = 1;
    let currentFilters = {
        category: 'frozen', // Set to babycare to filter only baby products
        subcategory: 'all',
        searchQuery: '',
        priceRange: 50,
        ratings: [],
...
const BACKEND_URL = 'https://mina-market-2.onrender.com';
    ...
    return false;
        ...
        try {
            ...
            const response = await fetch('https://mina-market-2.onrender.com/api/products/search?category=frozen&limit=1', {
                signal: controller.signal
            });
...
async function fetchProductsFromMongoDB(filters, page = 1) {
  ...
  try {
    ...
    function filterLocalProducts(filters) {
        return frozenProducts.filter(product => {
            // Always filter by frozen category for this page
    ...
    async function initializePage() {
        ...
        if (isMongoDBConnected) {
            ...
            populateProductsGrid(frozenProducts);
        }
    }
