    ...
    // home corner products data (fallback)
    const homeProducts = [
      {
        id: "h1",
      ...
      },
      {
        ...
        brand: "decor-style",
        features: ["living", "bedroom"],
        material: "polyester"
      },
      // Add more home products here as needed
    ];
    ...
    let currentPage = 1;
    let currentFilters = {
        category: 'home', // Set to home to filter only home products
        subcategory: 'all',
        searchQuery: '',
        priceRange: 50,
        ratings: [],
  ...
  try {
    ...
    function filterLocalProducts(filters) {
        return homeProducts.filter(product => {
            // Always filter by Homecorner category for this page
    ...
    async function initializePage() {
        ...
        if (isMongoDBConnected) {
            ...
            populateProductsGrid(homeProducts);
        }
    }
